@if ($crud->hasAccess('update'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal-ajax-crud"><i class="fa fa-edit"></i> {{ trans('backpack::crud.edit') }}</a>
